// LLaMA 2 7B Transformer Forward Pass - Vectorized with matmul builtin
// Config: dim=4096, hidden_dim=11008, n_layers=32, n_heads=32, vocab=32000
...
fn llama2_forward(
    ...
    while (layer < n_layers) {
        ...
        q = matmul(wq, xb, q, 4096i, 4096i, 1i, wq_off, 0i, 0i);
        ...
        k = matmul(wk, xb, k, 4096i, 4096i, 1i, wk_off, 0i, 0i);
        ...
        v = matmul(wv, xb, v, 4096i, 4096i, 1i, wv_off, 0i, 0i);
        ...
        xb = matmul(wo, xb2, xb, 4096i, 4096i, 1i, wo_off, 0i, 0i);
        ...
        hb = matmul(w1, xb, hb, 11008i, 4096i, 1i, w1_off, 0i, 0i);
        ...
        hb2 = matmul(w3, xb, hb2, 11008i, 4096i, 1i, w3_off, 0i, 0i);
        ...
        xb = matmul(w2, hb, xb, 4096i, 11008i, 1i, w2_off, 0i, 0i);
