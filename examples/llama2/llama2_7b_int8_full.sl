...
fn llama2_7b_decode_i8(
    ...
    while (layer < n_layers) {
        ...
        i8<11008, 4096> w1_mat = tensor_from_array(w1_t, w1_offset);
        var Gate = tensor_matmul_nt(ffn_in, w1_mat);

        i8<11008, 4096> w3_mat = tensor_from_array(w3_t, w3_offset);
        ...
        i8<4096, 11008> w2_mat = tensor_from_array(w2_t, w2_offset);
    ...
    i8<32000, 4096> wcls_mat = tensor_from_array(wcls_t, 0i);
