// LLaMA 2 3B Transformer Forward Pass - Vectorized with matmul builtin
// Config: dim=2048, hidden_dim=8192, n_layers=32, n_heads=32, vocab=32000
...
fn llama2_forward(
    ...
    while (layer < n_layers) {
        ...
        q = matmul(wq, xb, q, 2048i, 2048i, 1i, wq_off, 0i, 0i);
        ...
        k = matmul(wk, xb, k, 2048i, 2048i, 1i, wk_off, 0i, 0i);
        ...
        v = matmul(wv, xb, v, 2048i, 2048i, 1i, wv_off, 0i, 0i);
        ...
        xb = matmul(wo, xb2, xb, 2048i, 2048i, 1i, wo_off, 0i, 0i);
        ...
        hb = matmul(w1, xb, hb, 8192i, 2048i, 1i, w1_off, 0i, 0i);
        ...
        hb2 = matmul(w3, xb, hb2, 8192i, 2048i, 1i, w3_off, 0i, 0i);
        ...
        xb = matmul(w2, hb, xb, 2048i, 8192i, 1i, w2_off, 0i, 0i);
